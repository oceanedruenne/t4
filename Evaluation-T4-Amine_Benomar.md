...
- Proposition 1 : Pour moi j'aurai mis directement au lancement du prototype les règles du jeu et le lexique pour ensuite commencer a jouer
- Proposition 2 : J'aurais mis plus de maladie au niveau du patient pour avoir d'autres interactions au niveau du médecin.
- Proposition 3 : J'aurais rajouter une fonctionnalité pour voir aussi la pensé du médecin pour voir comment le médecin pense lorque par exemple un patient se sens pas compris par le médecin.
...
Justifications : Le readme.md n'est pas complet il manque les captures d'écrans, le CDC.md n'a pas été déposé mais le dossier nommé respecte totalement les conventions de nommage d'un projet informatique. Il y a plusieurs commits plus de la moitié des commits avec un nom explicite mais il y on a quelques un qui laisse a désiré comme "Merge branch 'oceane' of git.unistra.fr:t4-poids-lourds/t4 into oceane"
...
Justifications :  Dans la matinée le prototype n'était pas encore près du cou j'ai exécuté le prototype à partir de 12h00. Il s'exécute via un lien vers un site Web, il y a une catégorie règles dans le jeu mais lorsque l'on clique sur le bouton "Règles du jeu" on peut apercevoir un commentaire avec la liste des règles du jeu, ce que j'aurais fait c'est lorsque l'on clique sur le bouton "Règles du jeu" il affiche en bas du bouton les listes de règles du jeu.
...
Justifications : Le CDC, est très bien rédigé avec le déroulement d'un jeu, les différents objectifs ainsi que les différents scénarios possibles, mais le diagramme de classe manque de commentaire, ainsi que les différentes questions que le médecin peut dire en fonction de la réponse du patient.
...
Justifications : Les différentes fonctionnalités principales sont bien présentes dans le prototype comme les différentes jauges, les interactions du médecin, la diminution des jauges en fonction de la réponse du médecin, mais il manque la fonctionnalité du joueur qui demande a son patient ces information personnel, ces fonctionnalités ne sont pas précisé avec une difficulté et les fonctionnalités additionnels n'ont pas été développé mais il ont été correctement expliqué dans le CDC.
...
Justifications : Il y a plusieurs scénarios proposés dans le CDC, mais dans le prototype il n'y a que le scénario principal qui a été pleinement développé qui respecte correctement le concept-cible.
