...
- Proposition 1 : Crée un system de score pour motiver.
- Proposition 2 : Adapter le jeux avec les couleurs pour mode sombre.
- Proposition 3 : Ajouter plusieurs type de caractère/personnage.
- Proposition 4 : Corriger les bugs
...
Justifications :
- Organisation : Il y a juste un lien à cliquer dans le readme pour lancer le jeu sur web.
- Versioning : Dans le commit tout est présent.
- Droits d'accès : Julien Gossa est Owner.
- README.md : Oui, tout est présent.
- CDC.md : le cdc est vraiment très compréhensible, il y a très peu de chose incompréhensible
...
Justifications :
- Installation : le prototype est sous forme de web qui est facile à démarer.
- Exécution : En cliquant sur un lien le prototype se démarre.
- Stabilité : Très stable après plusieurs sessions de jeu !
- Affordabilité : Le bouton règle ne fonctionne pas mais tout est très bien expliqué dans le CDC
- Transmission du concept : Grâce à ce jeu, on comprend bien les phrases qu'on doit répondre au passiant.
...
Justifications : 
- Modèle de document : Très compréhensible et respecte bien le modèle !
- Description de l'application : Tout est précis dans le CDC, le déroulement du jeu, les systems de paroles, des points.
- Modèle conceptuel : très bien fait, je comprend les relation grace au MCD.
...
Justifications : 
- Actions du joueur : On voit bien les actions passée lorsqu'on intérargi avec le jeu, mais ce qui est dommage c'est qu'il y a un bug.
- Information  au joueur : les informations qu'on a besoin sont donnée dans l'interface.
- Description du moteur interne : C'est bien indiqué dans le CDC
- Découpage mdulaire : On vois que c'est découpé avec le MCD
- Granularité des fonctionnalités : les commits sont fait régulièrement et les noms sont bien nommé.
- Exhaustivité des fonctionnalités : \
- Description des fonctionnalités : tout est indiqué dans le CDC
- Priorisation des fonctionnalités : \
- Difficulté des fonctionnalités : \
...
Justifications :
- Nombre : sont tous expliqués dans le CDC
- Exhaustivité : \
- Scénarios additionnels : D'après le CDC on comprend bien ce que les idées des scénarios additionnels. 

## Résultat T4
- Total d'item « Excellent » (2 point) : 23
- Total d'item « Satisfaisant » (1 point) : 2 
- Total d'item « Insatisfaisant » (0 point) : 0
- total des points (sur 50) : 48/50
